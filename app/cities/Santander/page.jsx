	...
	return (
		<section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
			...
			<div className="flex flex-col items-center justify-center min-h-screen py-8">
				...
				<h1 className="bold-52 lg:bold-88">Santander, Cantabria</h1>
				<p className="regular-16 mt-6 mb-10 text-gray-30 xl:max-w-[700px] text-center">
					a city located in northern Spain , capital of the uniprovincial
					autonomous community of Cantabria . With 172,606 inhabitants
					(2023), it is the most populated municipality in the autonomous
					community. It is the head of the Santander metropolitan area , a
					conurbation of more than 300,000 inhabitants that extends around the
					Bay of Santander .
				</p>
				{/* CityCard Section */}
				<div className="flex h-[640px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[640px] xl:h-[640px]">
					<CityCard backgroundImage="bg-bg-img-4" />
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{hotelsData
						.filter((hotel) => hotel.location === "SANTANDER")
						.map((hotel) => (
							<div
								key={hotel.id}
